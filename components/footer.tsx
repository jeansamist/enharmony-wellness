    ...
    <footer className="p-6 md:p-12 xl:p-24 bg-tertiary text-secondary mt-6 sm:mt-8 md:mt-10 lg:mt-12 xl:mt-16">
      <div className="container mx-auto space-y-6">
          ...
          <div className="space-y-4 w-full">
            <div>
              ...
              <div className="leading-normal opacity-70 text-xl text-balance">
                Explore simple, holistic ways to support your wellbeing and live
                more consciously — delivered straight to your inbox.
              </div>
            </div>
        ...
        <div className="opacity-70 text-xl">
          © Enharmony Wellness.
          <br />A media brand by Enharmony. Content on Enharmony Wellness is for
          educational purposes only. Some articles are medically reviewed and
